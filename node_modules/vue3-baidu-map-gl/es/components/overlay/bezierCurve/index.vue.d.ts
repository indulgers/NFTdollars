...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            strokeStyle: StrokeStyle;
            enableMassClear: boolean;
        }> & Omit<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<BezierCurveProps>, {
            strokeColor: string;
            strokeWeight: number;
            strokeOpacity: number;
            strokeStyle: string;
        ...
        $el: any;
        $options: import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<BezierCurveProps>, {
            strokeColor: string;
            strokeWeight: number;
            strokeOpacity: number;
            strokeStyle: string;
    ...
    } & Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<BezierCurveProps>, {
        strokeColor: string;
        strokeWeight: number;
        strokeOpacity: number;
        strokeStyle: string;
...
} & import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<BezierCurveProps>, {
    strokeColor: string;
    strokeWeight: number;
    strokeOpacity: number;
    strokeStyle: string;
