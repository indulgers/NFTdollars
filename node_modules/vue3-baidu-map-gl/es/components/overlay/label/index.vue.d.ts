...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            offset: LabelOffset;
            enableMassClear: boolean;
        }> & Omit<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<LabelProps>, {
            offset: () => {
                x: number;
                y: number;
            };
        ...
        $el: any;
        $options: import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<LabelProps>, {
            offset: () => {
                x: number;
                y: number;
            };
    ...
    } & Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<LabelProps>, {
        offset: () => {
            x: number;
            y: number;
        };
...
} & import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<LabelProps>, {
    offset: () => {
        x: number;
        y: number;
    };
