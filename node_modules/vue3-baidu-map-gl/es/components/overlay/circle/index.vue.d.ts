...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            geodesic: boolean;
            clip: boolean;
        }> & Omit<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<CircleProps>, {
            strokeColor: string;
            strokeWeight: number;
            strokeOpacity: number;
            fillColor: string;
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "fillColor" | "fillOpacity" | "strokeColor" | "strokeWeight" | "strokeOpacity" | "strokeStyle" | "enableMassClear" | "enableEditing" | "enableClicking" | "geodesic" | "clip">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $el: any;
        $options: import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<CircleProps>, {
            strokeColor: string;
            strokeWeight: number;
            strokeOpacity: number;
            fillColor: string;
    ...
    } & Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<CircleProps>, {
        strokeColor: string;
        strokeWeight: number;
        strokeOpacity: number;
        fillColor: string;
...
} & import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<CircleProps>, {
    strokeColor: string;
    strokeWeight: number;
    strokeOpacity: number;
    fillColor: string;
