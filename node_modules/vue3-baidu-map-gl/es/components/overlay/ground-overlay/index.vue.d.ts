...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            autoCenter: boolean;
            opacity: number;
        }> & Omit<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<GroundOverlayProps>, {
            autoCenter: boolean;
            opacity: number;
        }>>> & {
        ...
        $el: any;
        $options: import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<GroundOverlayProps>, {
            autoCenter: boolean;
            opacity: number;
        }>>> & {
            onInitd?: ((...args: any[]) => any) | undefined;
    ...
    } & Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<GroundOverlayProps>, {
        autoCenter: boolean;
        opacity: number;
    }>>> & {
        onInitd?: ((...args: any[]) => any) | undefined;
...
} & import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<GroundOverlayProps>, {
    autoCenter: boolean;
    opacity: number;
}>>> & {
    onInitd?: ((...args: any[]) => any) | undefined;
