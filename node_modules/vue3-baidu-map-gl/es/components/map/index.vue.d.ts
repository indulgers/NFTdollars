...
export declare type MapType = _MapType;
...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            enablePinchToZoom: boolean;
            enableAutoResize: boolean;
        }> & Omit<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<MapProps>, {
            width: string;
            height: string;
            center: () => {
                lat: number;
        ...
        $el: any;
        $options: import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<MapProps>, {
            width: string;
            height: string;
            center: () => {
                lat: number;
            ...
            getBaseMapOptions: () => Readonly<MapProps> & {
                width: string | number;
                height: string | number;
                center: string | {
                    /**
    ...
    } & Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<MapProps>, {
        width: string;
        height: string;
        center: () => {
            lat: number;
...
} & import("vue").ComponentOptionsBase<Readonly<import("vue").ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToRuntimeProps<MapProps>, {
    width: string;
    height: string;
    center: () => {
        lat: number;
