(function (global, factory) {
  ...
  })(exports.DistrictType || (exports.DistrictType = {}));

  const _hoisted_1$3 = { style: { "color": "#999", "position": "absolute", "top": "50%", "left": "50%", "transform": "translate(-50%, -50%)" } };
  const __default__$l = {
      name: 'BMap'
  };
  var script$l = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$l), { props: {
          ak: null,
          width: { default: '100%' },
          ...
          const width = vue.computed(() => (isString(props.width) ? props.width : `${props.width}px`));
          const height = vue.computed(() => (isString(props.height) ? props.height : `${props.height}px`));
              ...
              return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
                  vue.createElementVNode("div", {
                      ...
                      vue.renderSlot(_ctx.$slots, "loading", {}, () => [
                          vue.createElementVNode("div", _hoisted_1$3, vue.toDisplayString(!vue.unref(initd) ? 'map loading...' : ''), 1)
                      ])
                  ], 4),
  ...
  var script$c = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$c), { emits: ['initd', 'unload'], setup(__props) {
          const { ready } = useLifeCycle();
  ...
  var script$b = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$b), { props: {
          position: null,
          offset: { default: () => ({
                  x: 0,
                  y: 0
  ...
  var script$5 = /*#__PURE__*/ vue.defineComponent(Object.assign(Object.assign({}, __default__$5), { props: {
          ...
          useBaseMapEffect((map) => {
              ...
              // 监听值变化
              vue.watch(() => props.position, callWhenDifferentValue((res) => {
                  console.log(res);
                  setPosition(res);
              }), { deep: true });
              vue.watch(() => props.offset, callWhenDifferentValue(setOffset), { deep: true });
  ...
  exports.CoordinatesFromType = void 0;
  ...
  })(exports.CoordinatesFromType || (exports.CoordinatesFromType = {}));
  exports.CoordinatesToType = void 0;
  ...
  })(exports.CoordinatesToType || (exports.CoordinatesToType = {}));
  ...
  exports.BBezierCurve = script$7;
  exports.BCircle = script$4;
  exports.BCityList = script$h;
  exports.BContextMenu = script$1;
  exports.BControl = script$k;
  exports.BCopyright = script$f;
  exports.BDistrictLayer = script;
  exports.BGroundOverlay = script$2;
  exports.BInfoWindow = script$5;
  exports.BLabel = script$9;
  exports.BLocation = script$g;
  exports.BMap = script$l;
  exports.BMarker = script$b;
  exports.BMarker3d = script$a;
  exports.BNavigation3d = script$e;
  exports.BPanoramaControl = script$d;
  exports.BPanoramaCoverageLayer = script$c;
  exports.BPolygon = script$6;
  exports.BPolyline = script$8;
  exports.BPrism = script$3;
  exports.BScale = script$j;
  exports.BZoom = script$i;
  ...
  exports.useDefaultMarkerIcons = useDefaultMarkerIcons;
  exports.useIpLocation = useIpLocation;
  exports.usePoint = usePoint;
  exports.usePointConvertor = usePointConvertor;
